...
mapEmployees.forEach((value,key) => {
    console.log(`Employe id ${key}===>  Name : ${value.emp_name} work in a deperment : ${value.emp_dept} comapny name is :${value.emp_company} and there salary is ${value.emp_salary}`);
});